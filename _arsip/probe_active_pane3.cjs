...
var val=ap._value||ap.value();
out.valType=typeof val;
if(!val||typeof val!=='object'){out.noVal=true;return JSON.stringify(out)}
out.valKeys=Object.keys(val).slice(0,25);
var st=val._state;
...
if(s){
  ...
  try{var g=s._graphics;out.ixLen=g._indexes?g._indexes.length:0;var pc=g._primitivesCollection;var dl=pc.dwglines;out.dwgSize=dl&&dl.size!=null?dl.size:null}catch(e){out.gErr=e.message}
}
