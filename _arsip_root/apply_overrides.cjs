      ...
      const r2 = await send('Runtime.evaluate', {
        expression: `(function(){
          ...
          return JSON.stringify({
            ...
            bup: p.mainSeriesProperties.candleStyle.borderUpColor,
            bdn: p.mainSeriesProperties.candleStyle.borderDownColor,
            wup: p.mainSeriesProperties.candleStyle.wickUpColor,
            wdn: p.mainSeriesProperties.candleStyle.wickDownColor
          });
        })()`,
        returnByValue: true
      });
